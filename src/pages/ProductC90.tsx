        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-neutral-600">
              Detail konstruksi dan komponen C Vent Type C-90
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="overflow-hidden border-0 shadow-xl">
              <CardContent className="p-8">
                <img 
                  src="/lovable-uploads/0f792121-de6c-4685-aa34-b78f73bd00e8.png"
                  alt="Diagram Teknis C Vent Type C-90 - Konstruksi Internal dan Komponen"
            ...
            <div className="mt-8 bg-neutral-50 p-6 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-neutral-600">
                <div>• Topi 1 mm</div>
                <div>• Fan Conventional 49 pcs 0,6 mm</div>
