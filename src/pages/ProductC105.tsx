          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-square overflow-hidden bg-neutral-100 rounded-xl">
              <img 
                ...
                alt="C Vent Type C-105 - Turbine Ventilator"
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-neutral-600">
              Detail konstruksi dan komponen C Vent Type C-105
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="overflow-hidden border-0 shadow-xl">
              <CardContent className="p-8">
                <img 
                  src="/lovable-uploads/df0ed382-fc3c-474e-a16d-7f442948767a.png"
                  alt="Diagram Teknis C Vent Type C-105 - Konstruksi Internal dan Komponen"
            ...
            <div className="mt-8 bg-neutral-50 p-6 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-neutral-600">
                <div>• Topi 1 mm</div>
                <div>• Fan Conventional 55 pcs 0,6 mm</div>
                <div>• Shaft Construction 20 mm</div>
                <div>• Double Fan 6 pcs 0,6 mm</div>
                <div>• Bearing FBJ Made in Japan Full Stainless Steel</div>
                <div>• Flexible Ducting 0,8 mm</div>
                <div>• Wings Plate 0,8 mm</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              ...
              asChild
            >
              <Link to="/kontak">Konsultasi Premium</Link>
            </Button>
          </div>
        </div>
      </section>
